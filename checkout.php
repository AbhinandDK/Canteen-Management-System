...
<section class="checkout-orders">
   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Class and Departement :</span>
            <input type="text" name="street" placeholder="Give details if you are student otherwise type NA" class="box" required>
         </div>
